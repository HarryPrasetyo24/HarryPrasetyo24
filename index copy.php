...
<body>
    ...
    <main>
        ...
        <sectoion class="section-related-product-content" id="popularContent">
            <div class="container">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3">
                        <div class="card-related text-center d-flex flex-column shadow-sm">
                            <?php 
                                    ...
                                    $query = mysqli_query($koneksi, "SELECT * FROM barang WHERE status='on' ORDER BY rand()");
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 text-center">
                        <img src="frontend/images/sponsor.png" alt="Logo Sponsor" class="img-partner" />
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="card card-news text-center d-flex flex-column">
                            <div class="news-content">
                                <?php 
                                    ...
                                    $query = mysqli_query($koneksi, "SELECT * FROM berita WHERE status='on' ORDER BY rand()");
                                    $row=mysqli_fetch_assoc($query);
