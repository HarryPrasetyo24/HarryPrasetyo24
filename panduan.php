...
<body>
    ...
    <main>
        <section class="page-panduan" style="min-height:90vh">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-sm-3 col-md-3 col-lg-5">
                        <h1 style="margin-top: 100px;">Panduan Pelayanan</h1>
                    </div>
                </div>
                <div class="d-grid gap-2 col-5 mx-auto">
                    <a class="btn btn-signup w-75 mt-4 shadow" href="panduan_pembelian.php">
                        Cara Melakukkan Pembelian Produk
                    </a>
                    <a class="btn btn-signup w-75 mt-4 shadow" href="panduan_resep.php">
                        Cara Menebus Resep Dokter
                    </a>
                </div>
