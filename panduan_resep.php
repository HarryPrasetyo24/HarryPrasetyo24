                    ...
                    <div class="col pl-0">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Cara Menebus Resep Dokter</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <section class="tutorial-content">
            <div class="container">
                ...
                <div class="title-tutorial">
                    <h1> Cara Menebus Resep Dokter</h1>
                    <hr />
                </div>
                <div class="isi-tutorial">
                    <p>
                        Anda harus melakukan Login terlebih dahulu sebelum menebus resep resep. Jika belum memiliki
                        akun, silakan
                        daftar yang
                        berada pada menu login.
                    </p>
                    <p>
                        <b>Langkah 1 </b> - Klik pada menu Resep Dokter yang ada pada bagian navigasi bar. navigasi bar
                        terletak
                        pada bagian atas. setelah itu pilih Upload Resep Dokter.
                    </p>
                    <div class="text-center mb-4">
                        <img src="frontend/images/menu-resep.jpg" alt="">
                    </div>
                    <p>
                        <b>Langkah 2 </b> - Isi data diri penebus resep dengan lengkap dan upload foto resep.
                    </p>
                    <div class="text-center mb-lg-4">
                        <img src="frontend/images/tutorial-menu-resep.JPG" alt="">
                    </div>
                    <p><b>Langkah 3 </b> - Klik pada bagian detail resep.</p>
                    <div class="text-center mb-lg-4">
                        <img src="frontend/images/tutorial-menu-MyProfileResep.JPG" alt="">
                    </div>
                    <p><b>Langkah 4 </b> - Pastikan Data - data yang anda masukkan sudah benar. lalu tunggu admin
                        memasukkan harga dari resep tersebut.</p>
                    <div class="text-center mb-lg-4">
                        <img src="frontend/images/tutorial-menu-detailresep.JPG" alt="">
                    </div>
                    <p><b>Langkah 5 </b> - Jika admin sudah mengupdate harga resep tersebut tampilannya akan seperti
                        ini. Kemudian jika anda sudah
                        melakukan pembayaran silakan lakukan
                        konfirmasi pembayaran yang berada pada bagian bawah.</p>

                    <div class="text-center mb-lg-4">
                        <img src="frontend/images/tutorial-menu-detailresep1.JPG" alt="">
                    </div>
                    <p><b>Langkah 6 </b> - Kemudian yang terakhir isi data rekening yang melakukkan pembayaran dan
